$(document).on('turbolinks:load', function() {
  ...
  const randomList1 = ["/images/games/slide/1.png","/images/games/slide/2.png","/images/games/slide/3.png",
                      "/images/games/slide/4.png","/images/games/slide/5.png","/images/games/slide/6.png",
                      "/images/games/slide/7.png","/images/games/slide/8.png","/images/games/slide/9.png",
                      "/images/games/slide/10.png","/images/games/slide/11.png","/images/games/slide/12.png"
                  ];
  const num1 = Math.floor(Math.random() * randomList1.length);
  document.getElementById("top-image").src = randomList1[num1];

  const randomList2 = ["/images/games/gacha/1.png","/images/games/gacha/2.png","/images/games/gacha/3.png",
                      "/images/games/gacha/4.png","/images/games/gacha/5.png","/images/games/gacha/6.png"
                  ];
  ...
  $(function changeTopImage(){
    ...
    grablu.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/grablu-title.png';
    ...
    shadowverse.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/shadowverse-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    priconne.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/priconne-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    fankill.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/fankill-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    fgo.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/fgo-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    pazdra.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/pazdra-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    monst.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/monst-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    dqwalk.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/dqwalk-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    yugioh.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/yugioh-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });

    feh.addEventListener('click',()=>{
      document.getElementById(Image).src='/images/games/top-image/feh-title.png';
      document.getElementById(item2).innerText = "↑ 遊びたいガチャを選ぼう！ ↑";
      document.getElementById(item2).classList.add(pyon);
    });
