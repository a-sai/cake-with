  ...
  $(function(){
    ...
    'use strict';
    {
      ...
      grablu1.addEventListener('click',()=>{
        document.getElementById(Image).src='/images/games/grablu/gacha.png';
      ...
      $(document).on('click', '#grablu-gacha-btn', function(){
        ...
        switch(gr){
          ...
          case 4:
          const results4 = ["/images/games/grablu/summon/1.png","/images/games/grablu/summon/2.png","/images/games/grablu/summon/3.png",
          ...
          case 3:
          const results3 = ["/images/games/grablu/ssr/1.png","/images/games/grablu/ssr/2.png","/images/games/grablu/ssr/3.png",
          ...
          case 2:
          const results2 = ["/images/games/grablu/sr/1.png","/images/games/grablu/sr/2.png","/images/games/grablu/sr/3.png",
                            "/images/games/grablu/sr/4.png","/images/games/grablu/sr/5.png","/images/games/grablu/sr/6.png",
                            "/images/games/grablu/sr/7.png","/images/games/grablu/sr/8.png","/images/games/grablu/sr/9.png",
                            "/images/games/grablu/sr/10.png"
                          ];
          ...
          default:
          const results1 = ["/images/games/grablu/r/1.png","/images/games/grablu/r/2.png","/images/games/grablu/r/3.png",
                            "/images/games/grablu/r/4.png","/images/games/grablu/r/5.png","/images/games/grablu/r/6.png",
                            "/images/games/grablu/r/7.png","/images/games/grablu/r/8.png","/images/games/grablu/r/9.png",
                            "/images/games/grablu/r/10.png"
                          ];
