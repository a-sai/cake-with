    ...
    'use strict';
    {
      ...
      $(document).on('click', '#pazdra-gacha-btn', function(){
        ...
        switch(gr){
          ...
          case 3:
          const results3 = ["/images/games/pazdra/ssr/1.png","/images/games/pazdra/ssr/2.png","/images/games/pazdra/ssr/3.png",
          ...
          case 2:
          const results2 = ["/images/games/pazdra/sr/1.png","/images/games/pazdra/sr/2.png","/images/games/pazdra/sr/3.png",
                            "/images/games/pazdra/sr/4.png", "/images/games/pazdra/sr/5.png","/images/games/pazdra/sr/6.png",
                            "/images/games/pazdra/sr/7.png", "/images/games/pazdra/sr/8.png","/images/games/pazdra/sr/9.png",
                            "/images/games/pazdra/sr/10.png"
                          ];
          ...
          default :
          const results1 = ["/images/games/pazdra/r/1.png","/images/games/pazdra/r/2.png","/images/games/pazdra/r/3.png",
                            "/images/games/pazdra/r/4.png","/images/games/pazdra/r/5.png","/images/games/pazdra/r/6.png",
                            "/images/games/pazdra/r/7.png","/images/games/pazdra/r/8.png","/images/games/pazdra/r/9.png",
                            "/images/games/pazdra/r/10.png"
                          ];
